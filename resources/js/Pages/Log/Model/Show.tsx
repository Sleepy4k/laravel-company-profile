...
export default function Show({
    ...
    return (
        <AuthenticatedLayout
            title={trans("page.log.model.show.title", "View Model Log")}
            header={
                <ResponsiveHeader>
                    <Link
                        href={backUrl}
        ...
        >
            <div className="bg-white dark:bg-gray-800 lg:w-[35rem] w-[20rem] mx-auto px-6 py-4">
                <div>
                    ...
                    >
                        {trans("page.log.model.field.id", "ID")}
                    </label>
                    <TextInput
                        disabled
                        id="id"
                ...
                <div className="mt-4">
                    <label
                        ...
                        className="block text-sm font-medium text-gray-700 dark:text-gray-400"
                    >
                        {trans("page.log.model.field.event", "Event")}
                    </label>
                    <TextInput
                        disabled
                        id="event"
                ...
                <div className="mt-4">
                    ...
                    >
                        {trans(
                            "page.log.model.field.subject_type",
                            "Subject Type"
                        )}
                    </label>
                    <TextInput
                ...
                <div className="mt-4">
                    <label
                        ...
                        className="block text-sm font-medium text-gray-700 dark:text-gray-400"
                    >
                        {trans("page.log.model.field.subject_id", "Subject Id")}
                    </label>
                    <TextInput
                        disabled
                        id="subject_id"
                ...
                <div className="mt-4">
                    ...
                    >
                        {trans(
                            "page.log.model.field.causer_type",
                            "Causer Type"
                        )}
                    </label>
                    <TextInput
                ...
                <div className="mt-4">
                    <label
                        ...
                        className="block text-sm font-medium text-gray-700 dark:text-gray-400"
                    >
                        {trans("page.log.model.field.causer_id", "Causer Id")}
                    </label>
                    <TextInput
                        disabled
                        id="causer_id"
                ...
                <div className="mt-4">
                    ...
                    >
                        {trans(
                            "page.log.model.field.description",
                            "Description"
                        )}
                    </label>
                    <TextInput
                ...
                <div className="mt-4">
                    <label
                        ...
                        className="block text-sm font-medium text-gray-700 dark:text-gray-400"
                    >
                        {trans("page.log.model.field.properties", "Properties")}
                    </label>
                    <textarea
                        disabled
                        id="properties"
                ...
                <div className="mt-4">
                    <label
                        ...
                        className="block text-sm font-medium text-gray-700 dark:text-gray-400"
                    >
                        {trans("page.log.model.field.created_at", "Created At")}
                    </label>
                    <TextInput
                        disabled
                        id="created_at"
                ...
                <div className="mt-4">
                    <label
                        ...
                        className="block text-sm font-medium text-gray-700 dark:text-gray-400"
                    >
                        {trans("page.log.model.field.updated_at", "Updated At")}
                    </label>
                    <TextInput
                        disabled
                        id="updated_at"
