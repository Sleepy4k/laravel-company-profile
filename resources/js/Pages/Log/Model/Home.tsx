...
export default function Home({
    ...
    return (
        <AuthenticatedLayout
            title={trans("page.log.model.title", "Model Log")}
            header={
                <ResponsiveHeader>
                    <Link
                    ...
                    header={
                        <>
                            ...
                            <TableHeading
                                ...
                                sortChanged={sortChanged}
                            >
                                {trans("page.log.model.field.causer", "Causer")}
                            </TableHeading>
                            <TableHeading
                                name="description"
                                sort_field={queryParams.sort_field}
                            ...
                            <th className="px-3 py-2">
                                {trans(
                                    "page.log.model.field.properties",
                                    "Properties"
                                )}
                            </th>
                            <TableHeading
                            ...
                            >
                                {trans(
                                    "page.log.model.field.created_at",
                                    "Created At"
                                )}
                            </TableHeading>
                            <TableHeading
                            ...
                            >
                                {trans(
                                    "page.log.model.field.updated_at",
                                    "Updated At"
                                )}
                            </TableHeading>
                            <th className="px-3 py-2">
