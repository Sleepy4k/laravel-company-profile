...
export default function Home({
    ...
    const searchFieldChanged = (name: string, value: string) => {
        ...
        router.get(route("log.system.index"), queryParams);
    };
    ...
    const handleReset = () => {
        ...
        router.get(route("log.system.index"));
    };
    ...
    return (
        <AuthenticatedLayout
            title={trans("page.log.system.title", "System Log")}
            header={
                <ResponsiveHeader>
                    <Link
                ...
                <DataTable
                    ...
                    header={
                        <>
                            ...
                            >
                                {trans(
                                    "page.log.system.field.file_name",
                                    "File Name"
                                )}
                            </TableHeading>
                            <TableHeading
                            ...
                            >
                                {trans(
                                    "page.log.system.field.file_type",
                                    "File Type"
                                )}
                            </TableHeading>
                            <TableHeading
                            ...
                            >
                                {trans(
                                    "page.log.system.field.content_type",
                                    "Content Type"
                                )}
                            </TableHeading>
                            <TableHeading
                            ...
                            >
                                {trans(
                                    "page.log.system.field.file_size",
                                    "File Size"
                                )}
                            </TableHeading>
                            <TableHeading
                            ...
                            >
                                {trans(
                                    "page.log.system.field.last_modified_at",
                                    "Last Modified At"
                                )}
                            </TableHeading>
