...
import ErrorIcon from "@/Components/Installer/ErrorIcon";
    ...
    return (
        <InstallationLayout step={1} errors={errors} title="Requirements">
            <div className="p-3">
                ...
                <h4 className="mb-5 mt-10 text-lg font-semibold text-neutral-800">
                        ...
                        <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                            <div className="overflow-hidden border border-neutral-200 shadow-sm sm:rounded-lg">
                                <table className="min-w-full divide-y divide-neutral-200">
                                    ...
                                    <tbody>
                                        {Object.entries(
                                            requirements["results"]["functions"]
                                        ).map(([func, enabled]) => (
                                            <tr key={func}>
                                                <td className="whitespace-nowrap px-4 py-2 text-sm font-medium text-neutral-900">
                                                    {func}
                    ...
                    <div className="flex">
                        ...
                        <div className="ml-3">
                            <h3 className="text-sm font-medium text-warning-800">
                                You need to fix the requirements in order to
