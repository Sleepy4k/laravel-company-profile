        ...
        <InstallationLayout step={5} errors={errors} title="Finish">
            <div className="p-3">
                ...
                <p className="text-neutral-700">
                    ...
                    , if you want to add data dummy to the database, you can run
                    the command below:
                </p>
                ...
                <p className="mt-4 text-neutral-700">
                    If you are not certain on how to configure the database
                    seeder with the minimum required PHP version (
                    {minPhpVersion}), the best is to consult with experienced
                    laravel developers.
                </p>
                ...
                <p className="text-neutral-700">
                    To run the scheduler, you should add the following Cron
                ...
                <p className="text-neutral-700">
                    ...
                    minute. When the schedule:run command is executed, Laravel
                    will evaluate your scheduled tasks and runs the tasks that
                    are due.
                </p>
                ...
                <p>
                    ...
                    <span className="select-all dark:text-black">
                        {user.name || "-"}
                    </span>
                    <br />
                    <span className="font-semibold text-neutral-700">
