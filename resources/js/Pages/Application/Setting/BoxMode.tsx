                                ...
                                <div className='button-hidden group px-4 py-2'>
                                    <div className='flex'>
                                        <div className='flex-grow overflow-hidden text-ellipsis whitespace-nowrap'>
                                            <Link href={route('application.show', setting.id)} className='overflow-hidden text-ellipsis whitespace-nowrap text-sm font-medium text-neutral-900 focus:outline-none hover:text-neutral-500'>
                                        ...
                                        <div className='ms-2'>
                                            <div className='flex flex-col items-center space-y-1'>
                                                <PopOver>
                                                    <Link
                                                        href={route('application.show', setting.id)}
                                                    ...
                                                    <Link
                                                        href={route('application.edit', setting.id)}
                                                        className="block px-4 py-2 text-sm text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700"
                                                    >
                                                        <div className='flex flex-row'>
