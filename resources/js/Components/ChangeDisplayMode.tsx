export default function ChangeDisplayMode({ onChange, checked }: { onChange: () => void, checked: boolean }) {
    return (
        <label className="swap swap-rotate relative lg:py-2 py-1 lg:px-3 px-1 rounded light:shadow transition-all">
            <input type="checkbox" title='change mode for display data' className='hidden' onChange={onChange} checked={checked} />
            <svg
